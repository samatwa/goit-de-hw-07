...
with DAG(
    ...
    create_table_task = MySqlOperator(
        ...
        sql="""
        CREATE TABLE IF NOT EXISTS oleksiy.hw_dag_results (
    ...
    calc_bronze_task = MySqlOperator(
        ...
        mysql_conn_id=connection_name,
        sql="""
            INSERT INTO oleksiy.hw_dag_results (medal_type, count, created_at)
    ...
    check_for_correctness = SqlSensor(
        ...
        sql="""SELECT NOW()-created_at < 30  from oleksiy.hw_dag_results hdr 
                ORDER BY id DESC 
                LIMIT 1;""",
        mode='poke',
        poke_interval=15,
