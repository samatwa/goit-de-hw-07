...
with DAG(
    ...
    landing_to_bronze = SparkSubmitOperator(
        ...
        application="dags_oholodetskyi/landing_to_bronze_oholodetskyi.py",  # Шлях відносно кореня репо
    ...
    bronze_to_silver = SparkSubmitOperator(
        ...
        application="dags_oholodetskyi/bronze_to_silver_oholodetskyi.py",
    ...
    silver_to_gold = SparkSubmitOperator(
        ...
        conn_id="spark-default",
        application="dags/oholodetskyi_silver_to_gold_oholodetskyi.py",
