...
with DAG(
    ...
    landing_to_bronze = SparkSubmitOperator(
        ...
        application="oholodetskyi/dags/landing_to_bronze_oholodetskyi.py",  # Шлях відносно кореня репо
    ...
    bronze_to_silver = SparkSubmitOperator(
        ...
        application="oholodetskyi/dags/bronze_to_silver_oholodetskyi.py",
    ...
    silver_to_gold = SparkSubmitOperator(
        ...
        conn_id="spark-default",
        application="oholodetskyi/dags/silver_to_gold_oholodetskyi.py",
