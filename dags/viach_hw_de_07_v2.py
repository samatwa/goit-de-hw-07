...
connection_name = "goit_mysql_db_viacheslav"
...
with DAG(
    ...
    create_table = MySqlOperator(
        ...
        sql="""
        CREATE TABLE IF NOT EXISTS viacheslav.medal_results (
    ...
    calc_Gold = MySqlOperator(
        ...
        mysql_conn_id=connection_name,
        sql="""
        INSERT INTO viacheslav.medal_results (medal_type, count)
