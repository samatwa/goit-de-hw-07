...
with DAG(
    ...
    landing_to_bronze_all = SparkSubmitOperator(
        application='/root/airflow-docker/dags/eugene/landing_to_bronze.py',  # Шлях до скрипту
    ...
    bronze_to_silver_all = SparkSubmitOperator(
        application='/root/airflow-docker/dags/eugene/bronze_to_silver.py',  
    ...
    silver_to_gold_avg_stats = SparkSubmitOperator(
        application='/root/airflow-docker/dags/eugene/silver_to_gold.py',  
